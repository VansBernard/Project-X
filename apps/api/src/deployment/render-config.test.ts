...
test("Render deploy resolves failed Prisma migrations before API startup", () => {
  ...
  assert.match(renderYaml, /migrate resolve --applied 202608140001_pending_dealer_signups/i, "Render config should mark the partially-applied pending signup migration as applied before deploy");
